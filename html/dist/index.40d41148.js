...
})({"7gtOk":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3e0ccc7040d41148";
"use strict";
...
(0, _consts.ELEMENTS).chatSpace.addEventListener("scroll", ()=>{
    if ((0, _consts.ELEMENTS).chatSpace.scrollHeight - -(0, _consts.ELEMENTS).chatSpace.scrollTop < 450) (0, _render.messageSplice)();
});
(0, _consts.ELEMENTS).formMail.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _jsCookieDefault.default).set("mail", (0, _consts.ELEMENTS).mailInput.value);
});
(0, _consts.ELEMENTS).formInput.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _async.sendindMessageWebSocket)((0, _consts.ELEMENTS).messageInput);
});
(0, _consts.ELEMENTS).formMail.addEventListener("submit", (0, _async.gettingCode));
(0, _consts.ELEMENTS).formNamePopup.addEventListener("submit", ()=>(0, _async.settingName)((0, _consts.ELEMENTS).inputNamePopup.value));
(0, _consts.ELEMENTS).formNamePopup.addEventListener("submit", ()=>{
    if ((0, _jsCookieDefault.default).get("token") == null || undefined) alert("Пройдите авторизацию");
    else {
        (0, _jsCookieDefault.default).set("name", (0, _consts.ELEMENTS).inputNamePopup.value);
        (0, _async.gettingNameInfo)((0, _consts.ELEMENTS).token);
    }
});
(0, _consts.ELEMENTS).buttonExit.addEventListener("click", ()=>{
    (0, _jsCookieDefault.default).remove("token");
    (0, _jsCookieDefault.default).remove("name");
    (0, _jsCookieDefault.default).remove("mail");
    (0, _consts.ELEMENTS).chatSpace.textContent = "";
    (0, _render.checkName)((0, _jsCookieDefault.default).get("name"));
});
document.addEventListener("DOMContentLoaded", ()=>(0, _render.checkName)((0, _jsCookieDefault.default).get("name")));
document.addEventListener("DOMContentLoaded", ()=>(0, _async.messageStories)());
(0, _consts.ELEMENTS).formEntryPopup.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _jsCookieDefault.default).set("token", (0, _consts.ELEMENTS).inputCodePopup.value);
});
(0, _consts.ELEMENTS).messageInput.addEventListener("mousemove", ()=>(0, _render.checkName)((0, _jsCookieDefault.default).get("name")));
(0, _consts.ELEMENTS).smiles.forEach((smile)=>{
    smile.addEventListener("click", (0, _render.entrySmile));
});
(0, _consts.socket).onmessage = function(event) {
    let webSocket = JSON.parse(event.data);
    (0, _render.sendingMessage)(webSocket.user.name, webSocket.text, webSocket.user.email, webSocket.createdAt);
};

},{"js-cookie":"c8bBu","./async":"havjN","./render":"9k0mC","./consts":"fWdKl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c8bBu":[function(require,module,exports) {
...
},{}],"havjN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "messageStories", ()=>messageStories);
parcelHelpers.export(exports, "settingName", ()=>settingName);
parcelHelpers.export(exports, "gettingNameInfo", ()=>gettingNameInfo);
parcelHelpers.export(exports, "gettingCode", ()=>gettingCode);
parcelHelpers.export(exports, "sendindMessageWebSocket", ()=>sendindMessageWebSocket);
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _consts = require("./consts");
var _render = require("./render");
async function messageStories() {
    try {
        let result = await fetch((0, _consts.ELEMENTS).stradaURLmessage, {
            method: "GET",
            headers: {
                "Content-Type": "application/json;charset=utf=8",
                Authorization: `Bearer ${(0, _consts.ELEMENTS).token}`
            }
        });
        ...
        if (result.ok) {
            console.log(info);
            (0, _render.messageSplice)();
        } else console.log("error");
    } catch  {
        console.log("err");
    }
}
async function settingName(name, token = (0, _jsCookieDefault.default).get("token")) {
    try {
        let result = await fetch((0, _consts.ELEMENTS).stradaURL, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json;charset=utf-8",
                Authorization: `Bearer ${(0, _consts.ELEMENTS).token}`
...
async function gettingNameInfo(token) {
    try {
        let result = await fetch((0, _consts.ELEMENTS).stradaURLinfo, {
            method: "GET",
            headers: {
                "Content-Type": "application/json;charset=utf-8",
                Authorization: `Bearer ${(0, _consts.ELEMENTS).token}`
...
async function gettingCode() {
    let user = {
        email: (0, _consts.ELEMENTS).mailInput.value
    };
    let result;
    try {
        result = await fetch((0, _consts.ELEMENTS).stradaURL, {
            method: "POST",
            headers: {
                "Content-Type": "application/json;charset=utf-8",
                Authorization: `Bearer ${(0, _consts.ELEMENTS).token}`
...
function sendindMessageWebSocket(message) {
    if (message.value === "") return (0, _consts.ELEMENTS).errorMessage.classList.add("entryMessageShow"), setTimeout(()=>(0, _consts.ELEMENTS).errorMessage.classList.remove("entryMessageShow"), 3000);
    (0, _consts.socket).send(JSON.stringify({
        text: message.value
    }));
}

},{"js-cookie":"c8bBu","./consts":"fWdKl","./render":"9k0mC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fWdKl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const ELEMENTS = {
    ...
    token: (0, _jsCookieDefault.default).get("token"),
...
const socket = new WebSocket(`wss://edu.strada.one/websockets?${ELEMENTS.token}`);

},{"js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}],"9k0mC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendingMessage", ()=>sendingMessage);
parcelHelpers.export(exports, "messageSplice", ()=>messageSplice);
parcelHelpers.export(exports, "checkName", ()=>checkName);
parcelHelpers.export(exports, "entrySmile", ()=>entrySmile);
var _dateFns = require("date-fns");
var _consts = require("./consts");
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
function sendingMessage(name, newMessage, mail, time) {
    const message = (0, _consts.ELEMENTS).templateMessage.content.querySelector(".messageNew");
    const timeMessage = (0, _consts.ELEMENTS).templateMessage.content.querySelector(".timeMessageNew");
    message.textContent = name + `: ` + newMessage;
    timeMessage.textContent = (0, _dateFns.format)(new Date(time), "HH:mm");
    ...
    cloneRight.append((0, _consts.ELEMENTS).templateMessage.content.cloneNode(true));
    cloneLeft.append((0, _consts.ELEMENTS).templateMessage.content.cloneNode(true));
    if (mail === (0, _jsCookieDefault.default).get("mail")) {
        if (newMessage.length === 0) alert("введите сообщение");
        else (0, _consts.ELEMENTS).chatSpace.append(cloneRight);
    } else (0, _consts.ELEMENTS).chatSpace.append(cloneLeft);
    (0, _consts.ELEMENTS).messageInput.value = "";
}
function messageSplice() {
    ...
    futureArray.forEach((info)=>sendingMessage(info.user.name, info.text, info.user.email, info.createdAt));
}
function checkName(cookie) {
    if (cookie != null || undefined || "") {
        (0, _consts.ELEMENTS).buttonEntry.remove();
        (0, _consts.ELEMENTS).topSettings.append((0, _consts.ELEMENTS).buttonExit);
    } else {
        (0, _consts.ELEMENTS).buttonExit.remove();
        (0, _consts.ELEMENTS).topSettings.append((0, _consts.ELEMENTS).buttonEntry);
    }
}
function entrySmile(e) {
    smile = e.currentTarget;
    (0, _consts.ELEMENTS).messageInput.value = (0, _consts.ELEMENTS).messageInput.value + smile.textContent;
}

},{"date-fns":"9yHCA","./consts":"fWdKl","js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7gtOk","bDbGG"], "bDbGG", "parcelRequirefd74")

//# sourceMappingURL=index.40d41148.js.map
